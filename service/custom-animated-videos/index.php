...
$page_title = 'Custom Animated Videos - Video Agency';
$page_description = 'Discover how Talking Heads can elevate your online presence!';
$canonical_url = '/service/custom-animated-videos/';
$og_type = 'article';
...
<main id="content" class="site-main post-339 service type-service status-publish hentry categoty-type-3d-animation">

			<div class="page-header">
			<h1 class="entry-title">Custom Animated Videos</h1>		</div>

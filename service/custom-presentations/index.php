...
$canonical_url = '/service/custom-presentations/';
$og_type = 'article';
...
<main id="content" class="site-main post-26 service type-service status-publish hentry">

			<div class="page-header">
			<h1 class="entry-title">VSL and Presentations</h1>		</div>

...
$page_title = 'App Walkthrough - Video Agency';
$page_description = 'Discover how Talking Heads can elevate your online presence!';
$canonical_url = '/service/app-walkthrough/';
$og_type = 'article';
...
<main id="content" class="site-main post-30 service type-service status-publish hentry categoty-type-app-walkthrough">

			<div class="page-header">
			<h1 class="entry-title">App Walkthrough</h1>		</div>
